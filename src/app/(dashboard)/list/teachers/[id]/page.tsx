		...
		<div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
				...
				<div className="flex flex-col lg:flex-row gap-4">
					...
					<div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
						...
						<div className="w-2/3 flex flex-col justify-between gap-4">
							<h3 className="text-xl font-semibold">Nio Pai</h3>
							<p className="text-xs text-gray-500">This is Dummy information for Teacher.</p>
							<div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
								...
								<div className="w-full md:w-1/3 flex items-center gap-2 lg:w-full 2xl:w-1/3">
									...
									<p className="">Jan 15</p>
								</div>
								<div className="w-full md:w-1/3 flex items-center gap-2 lg:w-full 2xl:w-1/3">
									<Image src="/mail.png" alt="" width={14} height={14} />
									<p className="">nishat@gmail.com</p>
								</div>
								<div className="w-full md:w-1/3 flex items-center gap-2 lg:w-full 2xl:w-1/3">
									<Image src="/phone.png" alt="" width={14} height={14} />
									<p className="">+1 234 567</p>
								</div>
							</div>
						</div>
					</div>
			...
			<div className="w-full xl:w-1/3 flex flex-col gap-4">
				<div className="bg-white p-4 rounded-md">
					...
					<div className="mt-4 gap-4 flex flex-wrap text-xs text-gray-400">
