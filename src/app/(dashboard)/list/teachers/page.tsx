...
const columns = [
	...
	{ header: "Teacher ID", accessor: "teacherId", className: "hidden lg:table-cell" },
...
export default async function teacherListPage({ searchParams }: { searchParams: { [key: string]: string | undefined } }) {
